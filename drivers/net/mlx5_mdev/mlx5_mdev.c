...
#ifdef RTE_LIBRTE_MLX5_MDEV_DLOPEN_DEPS
	if (mlx5_glue_init())
		return;
	assert(mlx5_glue);
#endif
...
RTE_PMD_REGISTER_PCI_TABLE(net_mlx5_mdev, mlx5_pci_id_map);
RTE_PMD_REGISTER_KMOD_DEP(net_mlx5_mdev, "* ib_uverbs & mlx5_core & mlx5_ib");
